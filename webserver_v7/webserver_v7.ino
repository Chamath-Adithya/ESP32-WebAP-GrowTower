...
void handleRoot() {
  ...
  html += "<p><strong>EC sensor value:</strong> " + String(sensorValue) + "</p><br>";
  html += "<p><strong>Water Templature:</strong> " + String(sensorValue2) + "</p><br>";
  html += "<p><strong>LDR value:</strong> " + String(ldrValue) + "</p><br>";
